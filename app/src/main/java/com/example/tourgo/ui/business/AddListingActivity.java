...
public class AddListingActivity extends AppCompatActivity {
    ...
    private static final int[] LABELS = {
            R.string.biz_step_basic, R.string.biz_step_location, R.string.biz_step_pricing,
            R.string.biz_step_calendar, R.string.biz_step_review
    };
    ...
    private void goBack() {
        ...
        else AdminUi.confirm(this, getString(R.string.biz_discard_title),
                getString(R.string.biz_discard_msg), getString(R.string.biz_discard), true, this::finish);
    }

    private void goNext() {
        if (step < TOTAL) { step++; render(); }
        else { toast(getString(R.string.biz_toast_published)); finish(); }
    }
    ...
    private View buildCircle(int n) {
        ...
        if (n < step) {
            ...
            FrameLayout.LayoutParams clp = new FrameLayout.LayoutParams(dp(12), dp(12), Gravity.CENTER);
            ...
            wrap.addView(num, new FrameLayout.LayoutParams(
    ...
    private void swapContent() {
        ...
        switch (step) {
            case 2: inf.inflate(R.layout.step_biz_location, content, true); bindLocation(); break;
            case 3: inf.inflate(R.layout.step_biz_pricing, content, true); bindPricing(); break;
            case 4: inf.inflate(R.layout.step_biz_availability, content, true); bindAvailability(); break;
            case 5: inf.inflate(R.layout.step_biz_review, content, true); bindReview(); break;
            case 1:
            default: inf.inflate(R.layout.step_biz_basic, content, true); bindBasic(); break;
        }
    }
    ...
    private void bindBasic() {
        ...
        hotel.setOnClickListener(v -> { kind = "hotel"; styleCatCards(hotel, tour); });
        tour.setOnClickListener(v -> { kind = "tour"; styleCatCards(hotel, tour); });
    ...
    private void bindLocation() {
        ...
        String[] labels = {getString(R.string.biz_am_wifi), getString(R.string.biz_am_pool),
                getString(R.string.biz_am_parking), getString(R.string.biz_am_breakfast),
                getString(R.string.biz_am_workspace), getString(R.string.biz_am_ac)};
        int[] icons = {R.drawable.ic_wifi, R.drawable.ic_pool, R.drawable.ic_garage,
                R.drawable.ic_tag, R.drawable.ic_workplace, R.drawable.ic_settings};
    ...
    private View buildAmenityChip(String label, int iconRes, boolean initialOn) {
        ...
        apply.run();
        chip.setOnClickListener(v -> { state[0] = !state[0]; apply.run(); });
    ...
    private void bindPricing() {
        ((TextView) content.findViewById(R.id.bizPriceLabel)).setText(
                "hotel".equals(kind) ? R.string.biz_base_price_night : R.string.biz_base_price_person);

        season(content.findViewById(R.id.bizSeasonPeak), R.string.biz_season_peak,
                R.string.biz_season_peak_range, R.string.biz_season_peak_delta,
                R.color.adm_red_100, R.color.adm_red_700);
        season(content.findViewById(R.id.bizSeasonMid), R.string.biz_season_mid,
                R.string.biz_season_mid_range, R.string.biz_season_mid_delta,
                R.color.adm_gray_200, R.color.adm_gray_700);
        season(content.findViewById(R.id.bizSeasonOff), R.string.biz_season_off,
                R.string.biz_season_off_range, R.string.biz_season_off_delta,
                R.color.adm_green_100, R.color.adm_green_700);
    ...
    private void season(View row, int labelRes, int rangeRes, int deltaRes,
                        @ColorRes int chipBg, @ColorRes int chipFg) {
    ...
    private void bindAvailability() {
        ...
        for (String d : new String[]{"S", "M", "T", "W", "T", "F", "S"}) {
            ...
            weekdays.addView(tv, new LinearLayout.LayoutParams(0,
    ...
    private View buildMiniCell(int day, boolean blocked, boolean selected) {
        ...
        if (day == 0) { cell.setText(""); return cell; }
    ...
    private void miniLegend(LinearLayout legend, @ColorRes int dotColor, int labelRes, boolean outline) {
        ...
        if (outline) g.setStroke(dp(1), color(R.color.adm_gray_300));
        dot.setBackground(g);
    ...
    private void bindReview() {
        AdminUi.catChip(this, content.findViewById(R.id.bizPreviewCatChip),
                content.findViewById(R.id.bizPreviewCatDot),
                (TextView) content.findViewById(R.id.bizPreviewCatLabel), kind);
        ((TextView) content.findViewById(R.id.bizPreviewName)).setText("The Grand Orchid Resort");
        ((TextView) content.findViewById(R.id.bizPreviewLoc)).setText("Bangkok, Thailand");
        String unit = getString("hotel".equals(kind) ? R.string.biz_per_night : R.string.biz_per_person);
        ((TextView) content.findViewById(R.id.bizPreviewPrice)).setText("$199 " + unit);

        LinearLayout summary = content.findViewById(R.id.bizReviewSummary);
        LayoutInflater inf = LayoutInflater.from(this);
        addSummary(inf, summary, getString(R.string.biz_summary_photos), getString(R.string.biz_summary_photos_value));
        addSummary(inf, summary, getString(R.string.biz_summary_amenities), getString(R.string.biz_summary_amenities_value));
        addSummary(inf, summary, getString(R.string.biz_summary_capacity), getString(R.string.biz_summary_capacity_value));
        addSummary(inf, summary, getString(R.string.biz_summary_pricing), getString(R.string.biz_summary_pricing_value));
